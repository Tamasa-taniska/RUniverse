...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($file['error'] === 0) {
        ...
        if (move_uploaded_file($file['tmp_name'], $filepath)) {
            $stmt = $data->prepare("INSERT INTO study_materials (faculty_email, semester, subject, file_name) VALUES (?, ?, ?, ?)");
...
$stmt = $data->prepare("SELECT * FROM study_materials WHERE faculty_email = ? ORDER BY upload_time DESC");
...
<head>
    ...
    <link rel="stylesheet" href="StudyMaterial.css">
</head>
<body>
