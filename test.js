...
document.addEventListener('DOMContentLoaded', function() {
    const alcoholForm = document.getElementById('assessment-form');
    if (alcoholForm) {
        alcoholForm.addEventListener('submit', handleAlcoholAddiction);
    }

    const internetForm = document.getElementById('assessment-form');
    if (internetForm) {
        internetForm.addEventListener('submit', handleInternetAddiction);
    }
    document.addEventListener('DOMContentLoaded', function() {
        const manageabilityForm = document.getElementById('assessment-form');
        if (manageabilityForm) {
            manageabilityForm.addEventListener('submit', handleManageability);
        }
    });
    document.addEventListener('DOMContentLoaded', function() {
        const copingResilienceForm = document.getElementById('assessment-form');
        if (copingResilienceForm) {
            copingResilienceForm.addEventListener('submit', handleCopingResilience);
        }
    });
    document.addEventListener('DOMContentLoaded', function() {
        const angerForm = document.getElementById('assessment-form');
        if (angerForm) {
            angerForm.addEventListener('submit', handleAngerAssessment);
        }
    });
    document.addEventListener('DOMContentLoaded', function() {
        const anxietyForm = document.getElementById('assessment-form');
        if (anxietyForm) {
            anxietyForm.addEventListener('submit', handleAnxietyAssessment);
        }
    });
    document.addEventListener('DOMContentLoaded', function() {
        const bullyingForm = document.getElementById('assessment-form');
        if (bullyingForm) {
            bullyingForm.addEventListener('submit', handleBullyingAssessment);
        }
    });
    document.addEventListener('DOMContentLoaded', function() {
        const depressionForm = document.getElementById('assessment-form');
        if (depressionForm) {
